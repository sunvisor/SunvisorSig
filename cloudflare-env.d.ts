/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 7d7939138076f414c198f05511a4d1cb)
...
declare namespace Cloudflare {
	interface Env {
		...
		DATABASE_URL: string;
		AUTH_SECRET: string;
		WORKER_SELF_REFERENCE: Fetcher /* sunvisor-sig */;
	}
}
